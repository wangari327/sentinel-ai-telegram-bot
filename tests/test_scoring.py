...
async def test_rules_only_deletes_sexual_solicitation_without_url() -> None:
    from app.moderation.ai_classifier import ClassificationRequest, RulesOnlyProvider
...
async def test_rules_only_deletes_private_file_solicitation_without_url() -> None:
    from app.moderation.ai_classifier import ClassificationRequest, RulesOnlyProvider
...
def test_link_only_ai_gate_escalates_private_solicitation_without_url() -> None:
    normalized = normalize_message_parts(text="Dm me. I have it")
    features = extract_features(normalized)
