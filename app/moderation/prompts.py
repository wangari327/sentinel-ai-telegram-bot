...
def build_classifier_messages(payload: dict[str, Any]) -> list[dict[str, str]]:
    instructions = {
        ...
        "be_sensitive_to": [
            ...
            "sexual partner solicitations, even without links",
            "DM/PM/inbox me offers for files, links, episodes, movies, or shows",
        ...
        "avoid_false_positives_for": [
            ...
            "people reacting to or complaining about spam in a reply, when their own message is not spam",
